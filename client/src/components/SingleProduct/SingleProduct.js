    ...
    <>
      { (
        <section className="w-[90%] h-auto mx-auto flex justify-between  my-12  md:flex-col">
          <aside className="flex flex-col 2xl:sticky top-20 md:static w-[40%] text-gray-800 dark:text-gray-200  bg-white/60 dark:bg-black/30 items-center h-[80%]  rounded-md my-2 p-4 md:w-[90%] md:h-[70%] sm:min-h-[300px] mx-auto">
